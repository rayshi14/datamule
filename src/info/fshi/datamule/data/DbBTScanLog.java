...
public class DbBTScanLog extends BasicTable {
	long _timestamp;
	short _tmp_rssi;
	long _fk_btdevice;
	int _scan_duration;
	 ...
	 * @param scan_duration
	 */
	public DbBTScanLog(long id, long timestamp, short rssi, long id_btdevice, int scan_duration, long scan_baseline){
		super(id);
	 ...
	 * @param id_btdevice
	 */
	public DbBTScanLog(long id, short rssi, int id_btdevice, int scan_duration, long scan_baseline){
		super(id);
