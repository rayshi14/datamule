...
public class DbBTDevice extends BasicTable {
	//private variables
	String _name;
	String _mac;
	private short _rssi;
	 ...
	 * @param mac
	 */
	public DbBTDevice(long id, String name, String mac){
		super(id);
		this._name = name;
		this._mac = mac;
		this._rssi = 0;
	 ...
	 * @param rssi
	 */
	public DbBTDevice(long id, String name, String mac, short rssi){
		super(id);
		this._name = name;
		this._mac = mac;
		this._rssi = rssi;
	 ...
	 * @param retry
	 */
	public DbBTDevice(long id, String name, String mac, short rssi, int state, int retry){
		super(id);
		this._name = name;
		this._mac = mac;
		this._rssi = rssi;
