...
public class DbBTComLog extends BasicTable {
	long _timestamp;
	short _tmp_rssi;
	long _fk_btdevice;
	long _delay;
	 ...
	 * @param delay
	 */
	public DbBTComLog(long id, long timestamp, short rssi, long id_btdevice, long delay){
		super(id);
	 ...
	 * @param delay
	 */
	public DbBTComLog(long id, short rssi, int id_btdevice, long delay){
		super(id);
